...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        '''Test list of recipes limited to auth user'''
        other_user = create_user(
            email='other@example.com', password='otherpass123456')
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            'title': 'Alambre con queso',
            'time_minutes': 60,
            'price': Decimal('12.4'),
            'ingredients': [{'name': 'Tortilla'}, {'name': 'Queso'}]
        }
    ...
    def test_create_recipe_with_existing_ingredients(self):
        """Test creating a recipe with new ingredients"""
        ingredient = Ingredient.objects.create(user=self.user, name='Queso')
        payload = {
            'title': 'Alambre con queso',
            'time_minutes': 60,
            'price': Decimal('12.4'),
